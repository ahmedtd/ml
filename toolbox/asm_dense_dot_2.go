...
func main() {
	TEXT("denseDot2", NOSPLIT,
		"func(n int, v0 []float32, v0Base int, v1 []float32, v1Base int) float32")
	...
	for i := 0; i < unroll; i++ {
		VFMADD231PS(v1.Offset(32*i), xs[i], acc[i])
	}
	...
	VFMADD231SS(v1, tailElement, tailAccumulator)
